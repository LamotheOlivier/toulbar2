...
The input is a pedigree data with partial observed genotyping data at a single locus, we will assume the pedigree to be exact, but not the genotyping data.
 ...
 The goal is to maximize the number of matching allelle between the genotyping data and the solution. Each distinction from the genotyping data will be of cost 1.
